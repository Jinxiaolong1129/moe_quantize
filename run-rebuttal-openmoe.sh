...
DEBUG=0 CUDA_VISIBLE_DEVICES=2,3 python lm_eval_gptq_openmoe.py \
    --model_name ../openmoe-checkpoints/openmoe-8b-native-pt \
    --quant_model_path autogptq_../openmoe-checkpoints/openmoe-8b-native-pt-gptq_w_bit_main_4.attn_4 \
    --is_quantized &

DEBUG=0 CUDA_VISIBLE_DEVICES=4,5 python lm_eval_gptq_openmoe.py \
    --model_name ../openmoe-checkpoints/openmoe-8b-native-pt \
    --quant_model_path autogptq_../openmoe-checkpoints/openmoe-8b-native-pt-gptq_w_bit_main_4.attn_4.layer_5_2.layer_11_2.layer_17_2.layer_23_2 \
    --is_quantized &