...
models = ["llama-moe/LLaMA-MoE-v1-3_5B-2_8"]
...
for model_name in models:
    ...
    model = AutoModelForCausalLM.from_pretrained(model_name, torch_dtype=torch.bfloat16, trust_remote_code=True,  cache_dir=custom_cache_dir)
    # config = AutoConfig.from_pretrained(
    #     "/data3/user/jin509/llama-moe/models--llama-moe--LLaMA-MoE-v1-3_5B-2_8", trust_remote_code=True
    # )
    break
