...
#     --nsamples 512 \
#     --group_size 64 \
#     --bits all_4 > log_cuda_4_all_2.out &
    
# CUDA_VISIBLE_DEVICES=0 python quantize_gptq_deepseek_combination_copy.py --group_size 64 --bits all_4
